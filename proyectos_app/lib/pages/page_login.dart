...
import 'package:proyectos_app/providers/persona_provider.dart';
...
class _LoginScreenState extends State<LoginPage>
  ...
  final usuarioProvider = new PersonaProvider();
  final usuario = new UsuarioRemoto();
...
//    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: _logueado ? CommentsPage(mensaje: mensaje) : loginForm(),
//      body: loginForm(),
    );
  }
    ...
    return IconButton(
      onPressed: () {
        if (_key.currentState.validate()) {
          ...
          usuario.email = _correo;
          usuario.password = _contrasena;
          usuarioProvider.loginUser(usuario);
          mensaje = 'Gracias \n $_correo \n $_contrasena';
